namespace Zhan.AsyncThread.Project
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btn_tongbu.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.btnThreads.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.btnThreadPool.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.btnParallel.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			// btnawait
			// 
			this.btnawait.Location = new System.Drawing.Point(301, 46);
			this.btnawait.Margin = new System.Windows.Forms.Padding(2);
			this.btnawait.Name = "btnawait";
			this.btnawait.Size = new System.Drawing.Size(92, 32);
			this.btnawait.TabIndex = 9;
			this.btnawait.Text = "await/async";
